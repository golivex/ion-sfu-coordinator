...
})(LeaseState = exports.LeaseState || (exports.LeaseState = {}));
/**
...
class Lease extends events_1.EventEmitter {
    ...
    keepalive() {
        ...
        this.client
            ...
            const keepAliveTimeout = util_1.debounce(1000 * this.ttl, () => this.handleKeepaliveError(new errors_1.GRPCCancelledError('GRPC watch stream has timed out.')));
            this.teardown = () => {
